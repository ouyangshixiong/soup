        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('jhipsterLiquibaseBugApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-jhipsterLiquibaseBugApp-error');
                                var entityKey = httpResponse.headers('X-jhipsterLiquibaseBugApp-params');
                                if (errorHeader) {
